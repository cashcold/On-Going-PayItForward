                ...
                <div className='confirmLine'>
                    <div className='lastConfirm'>
                        ...
                        <div className='confirmBtnInfo'>
                            <p>Please send exactly 0.00177447 BTC to<br/> <span style={{color: 'greenyellow'}}>1Cgr1ZqxpVfBxpN4ca1gNo1HbsZPTrjkUN</span><br/>
                                <h5>Order status: Waiting for payment</h5>
                            </p>
                        </div>
